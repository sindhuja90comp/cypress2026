...
export default function GrudgeList(){
    ...
    return (
        <div style={{margin: '20px'}}>
                    ...
                    grudges.length > 0 && (
                        grudges.map((g) => {
                           ...
                           <li key={g.id}>
                                ...
                                <Button data-test="delete-grudge-btn" onClick={() => deleteGrudge(g)}>
                                    X
                                </Button> 
                            </li>
                        )})
            ...
            {
                grudges.length > 0 && <Button data-test="clear-grudge-btn" onClick={clearGrudges}>Clear</Button>
            }
        </div>
    )
}